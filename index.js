...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
//Nested function has access to internal because functions can go OUTSIDE of their scope.
...
function summation(num) {
  let count = 0;
  for(let i = 0; i <= num; i++){
    count += i; //Kept trying to use num here like a knucklehead
  }
  return count
}
...
const zooAnimals = [
  ...
  */
  ...
  function USApop(array){
    let totalPop = array.reduce(function(acc, current){
